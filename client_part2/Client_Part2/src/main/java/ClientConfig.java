public class ClientConfig {
  public static final String SERVER_URL = "http://localhost:8080/CS6650_Assignment1_war_exploded/skiers";
  public static final int NUM_THREADS = 100;  // number of threads
  public static final int REQUESTS_PER_THREAD = 200;  // number of requests per thread
